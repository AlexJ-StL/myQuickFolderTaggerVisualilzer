...
def generate_3d_semantic_plot(file_path, output_image="semantic_3d_plot.png"):
    # Load the data generated by your LLM app
    ...
    # TF-IDF captures the importance of words within your tag system
    vectorizer = TfidfVectorizer(stop_words="english")
    tfidf_matrix = vectorizer.fit_transform(df["TAG"])

    # 2. Reduce dimensions to 3 (X, Y, Z) using PCA
    # This maps semantic similarity into spatial distance
    ...
    # 3. Categorize by Primary Technology for coloring
